   ...
   var $message=jQuery('<div class="yjl-mes"></div>').appendTo("#commentform");;
   var $list=$commentlist.children();
   var totalCom=$list.length;
   var $textarea=$respond.find('#comment_area').attr('rows','4');
   ...
   jQuery('#commentform').submit(function(){
       jQuery.ajax({
         beforeSend:function(xhr){
            ...
            $message.empty().append('<img src="'+yjlSettings.gifUrl+'" alt="Отправка комментария...">');
         },
         type:'post',
